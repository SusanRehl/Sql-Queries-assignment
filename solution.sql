--0.1 Get all users from Chicago
...
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('susan', 'burnsville', 0, 0, 1.59);
...
DELETE FROM syntax_practice WHERE city='phoenix' AND transactions_completed<5 OR city='miami' AND transactions_completed<5;